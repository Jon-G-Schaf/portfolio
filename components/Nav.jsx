...
export default function Nav() {
  ...
  return (
    ...
    <header className="sticky top-0 z-40 border-b border-line bg-ink/80 backdrop-blur-md before:pointer-events-none before:absolute before:inset-x-0 before:bottom-full before:h-28 before:bg-ink">
      <nav
        aria-label="Primary"
