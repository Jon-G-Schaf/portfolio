...
export const skillGroups = [
  ...
  },
  {
    ...
    skills: ["TypeScript", "C++", "C", "OCaml", "Git", "Docker", "Linux"],
  },
  {
    label: "Design",
...
export const featuredProject = {
  ...
  description:
    "A live map of every COTA bus in Columbus, and the reliability record the schedule can't give you. A TypeScript worker polls COTA's realtime feeds around the clock into Postgres, computes each route's actual on-time numbers in SQL (the feed doesn't publish delays, so Crosstown derives them against the published schedule), and streams positions to a Next.js + MapLibre front end over server-sent events. Designed, built, and shipped solo; live and recording since June 2026.",
...
export const otherProjects = [
  {
    ...
    year: "2025-26",
    description:
      "A Flutter + Firebase app for discovering local events (pickup games, club meetups, anything with a time and a place) and getting people to actually show: see what's happening nearby, claim an open spot, and coordinate over real-time chat. Built with a five-person capstone team at Ohio University; I led the UI/UX and carried much of the Flutter front end and the Firebase back end.",
