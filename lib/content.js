...
export const otherProjects = [
  ...
  },
  {
    ...
    year: "2025",
    description:
      "A Qt/QML desktop app for storing, organizing, and searching code snippets — folders, tags, favorites, and fast search over SQLite, backed by a clean layered C++ core, plus a companion VS Code extension. On a five-person software-engineering team I led the design: the visual identity, color system, and the snippet, search, and settings screens.",
    tags: ["Qt / QML", "C++", "SQLite"],
    href: "https://github.com/Ohio-University-CS/snipboard",
  },
];
