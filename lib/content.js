...
export const featuredProject = {
  ...
  name: "Quorum",
  tagline: "Find local games that need players — and actually show up.",
  description:
    "A Flutter + Firebase app for local pickup sports and events: discover what's happening near you, see which games still need players, claim an open spot, and coordinate with everyone over real-time chat. My CS capstone at Ohio University, built with a five-person team — I led the UI/UX and carried much of the build across the Flutter front end and the Firebase back end.",
