...
export const otherProjects = [
  {
    name: "Crosstown",
    type: "Full-stack web app · Live data",
    year: "2026",
    description:
      "A live map of every COTA bus in Columbus, with the reliability stats the schedule can't give you. A TypeScript worker ingests COTA's realtime feeds around the clock into Postgres, computes each route's actual on-time numbers in SQL, and streams positions to a Next.js + MapLibre front end over server-sent events.",
    tags: ["TypeScript", "Node.js", "PostgreSQL", "Next.js"],
