...
export const hero = {
  ...
  intro:
    "I build software end to end, with a strong focus on the interface. I'm a recent Computer Science graduate from Ohio University, and I care about type, spacing, and the small interactions that make software feel considered.",
