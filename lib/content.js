...
export const hero = {
  ...
  intro:
    "I build software end to end, with a lot of attention on the interface. I'm a recent Computer Science grad from Ohio University, and I care about type, spacing, and the small interactions that make software feel considered.",
};

export const about = {
  paragraphs: [
    "A Computer Science degree taught me to work across the stack: frontend, backend, and the glue in between. What I care about most is the part where software meets people. Type scale, spacing rhythm, and the first 200 milliseconds after a button press all matter. They are small details, but they change how finished a product feels.",
